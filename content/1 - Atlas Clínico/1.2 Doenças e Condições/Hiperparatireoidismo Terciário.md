...
- **Quadro Clínico:** É dominado pelos sintomas da **[[Hipercalcemia]]** grave, sobrepostos aos da uremia:
  - **[[Dor óssea intratável]]** (Osteíte Fibrosa Cística).
  - **[[Fraturas patológicas]]**.
  - **[[Prurido intratável]]** (muito comum e severo, relacionado ao [[Produto cálcio-fósforo elevado]]).
  - **[[Calcificação vascular]]** e de tecidos moles (Calcifilaxia).
  - [[Náuseas]], [[Vómitos]], [[Confusão mental]].
- Ao exame físico, as glândulas paratireoides podem estar tão aumentadas a ponto de serem palpáveis no pescoço.

---
## 🎯 ACHADOS-CHAVE (PIVÔS)
*O diagnóstico é bioquímico e define-se pela perda da regulação.*
...
- Hiperparatireoidismo Primário (nesta condição, o [[Fósforo sérico]] estaria baixo ou normal).
- Hiperparatireoidismo Secundário (nesta condição, o [[Cálcio sérico]] estaria baixo ou normal).

---
## 🔬 Investigação (Exames Relevantes)

### **1. Confirmação Bioquímica**
- **[[Cálcio sérico]]**, **[[Fósforo sérico]]** e **[[PTH intacto]]**: A tríade diagnóstica.
- **[[Fosfatase Alcalina elevada]]**: Reflete o altíssimo turnover ósseo.

### **2. Exames de Localização (Planeamento Cirúrgico)**
*Não são para diagnóstico, mas sim para localizar as glândulas autónomas antes da cirurgia.*
- **[[Ultrassonografia Cervical]]** (pode identificar glândulas muito aumentadas).
- **[[Cintilografia de Paratireoide com Sesta-MIBI]]**.

---
## 💊 Tratamento (Medicamentos e Procedimentos)
*O tratamento clínico é frequentemente ineficaz, sendo o tratamento cirúrgico o de escolha.*
...
### **2. Tratamento Definitivo (Cirúrgico)**
- **[[Paratireoidectomia]]**: É o tratamento de escolha.
  - **Técnicas:**
    - **[[Paratireoidectomia Subtotal]]**: Remoção de 3 glândulas e meia, deixando metade de uma glândula para evitar o hipoparatireoidismo permanente.
    - **[[Paratireoidectomia Total com Autoimplante]]**: Remoção de todas as 4 glândulas, com implante de uma pequena porção de tecido paratireoidiano no antebraço (para fácil acesso futuro, se necessário).

> [!warning] Complicação Pós-Operatória
> Após a cirurgia, os ossos (que estavam "famintos" por cálcio) começam a absorver grandes quantidades de cálcio e fósforo do sangue. Isso pode levar a uma **[[Síndrome da Fome Óssea]]**, resultando em **[[Hipocalcemia grave]]** e [[Hipofosfatemia]] no pós-operatório, exigindo [[Reposição intravenosa vigorosa de cálcio]].
