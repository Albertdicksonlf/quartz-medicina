---
classe: Anti-hipertensivo / Bloqueador do Sistema Renina-Angiotensina / Inibidor da Neprilisina
tipo: Medicamento
aliases:
  - ARNI
  - INRA
...
1.  **[[Valsartana]]**: Um **[[BRA]]** que bloqueia os efeitos deletérios da Angiotensina II no receptor AT1 (vasoconstrição, retenção de sódio, remodelamento).
2.  **[[Sacubitril]]**: É um pró-fármaco que, após ativação, **inibe a enzima Neprilisina**.
    - A Neprilisina é responsável por degradar vários peptídeos vasoativos endógenos benéficos, incluindo os **[[Peptídeos Natriuréticos (BNP ou NT-proBNP)]]**.
    - Ao inibir a Neprilisina, o Sacubitril **aumenta os níveis circulantes de Peptídeos Natriuréticos**, potencializando seus efeitos favoráveis: **[[Vasodilatação]]**, **[[Natriurese e Diurese]]**, inibição do SRAA e do SNS, e efeitos anti-remodelamento.
...
*Combina os efeitos adversos dos [[BRA]] com os do aumento dos peptídeos.*

- **[[Hipotensão]]**: Mais comum do que com IECA/BRA isolados. É o principal fator limitante para iniciar ou titular a dose.
...
- **[[Potássio sérico]]** e **[[Creatinina sérica]]** (antes, 1-2 semanas após início/aumento da dose, e periodicamente).
- **Biomarcador:** Lembrar que o [[Sacubitril/Valsartana]] [[Aumenta os níveis de BNP]]. Usar o **[[NT-proBNP]]** para monitoramento.
