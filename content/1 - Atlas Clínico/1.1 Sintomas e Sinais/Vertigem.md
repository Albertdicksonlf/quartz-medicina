...
> [!abstract] Definição
> Uma sensação ilusória de movimento, seja do próprio corpo ou do ambiente, tipicamente de natureza rotatória. Representa uma assimetria no sistema vestibular, que pode ser de origem periférica (labirinto, nervo vestibular) ou central (tronco encefálico, cerebelo).
...
2.  **Gatilhos (Triggers):**
    ...
    -   **Espontânea:** Sem gatilho aparente.
    -   **Outros:** Ruídos altos (Síndrome de Tullio), estresse, alimentos (gatilhos de enxaqueca).

3.  **Sintomas Associados:**
    -   **Sintomas Auditivos (Zumbido, perda de audição, plenitude aural):** Apontam fortemente para causa periférica, como na [[Doença de Meniere]]. A ausência de sintomas auditivos em uma síndrome vestibular aguda fala a favor de [[Neurite Vestibular]].
    -   **Sintomas Neurológicos (Diplopia, disartria, disfagia, ataxia, fraqueza, cefaleia súbita e intensa):** São **red flags** 🚩 que indicam uma provável causa central.
...
*- A principal tarefa do médico no departamento de emergência é diferenciar uma causa periférica benigna de uma causa central potencialmente fatal.*
*- Vertigem não é um diagnóstico, mas um sintoma de uma condição subjacente.*
